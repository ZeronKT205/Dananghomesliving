...
const sourceBaseDir = path.join(process.cwd(), 'public', 'images', 'tin', 'Villa');
...
const properties = [
  {
    code: 'Vi-01',
    transaction: 'thuê',
    title: 'Da Nang’s Finest Villas – Where Elegance Meets the Sea',
    categoryId: '6a82ff6930647ba01244cedd',
    project: 'One River Regal',
    bed: 4, bath: 4, area: 300, price: 5752, currency: 'USD',
    frequency: '/Tháng', location: 'Đà Nẵng', view: 'Private Garden, swimming pool, Cổ cò river',
    folderName: 'Villa One Regal ở FPT',
    floors: 3
  },
  {
    code: 'Vi-02',
    transaction: 'thuê',
    title: 'Stunning Private Pool Villas for Rent in Da Nang – Ideal for Families',
    categoryId: '6a82ff6930647ba01244cedd',
    project: 'Phan Bá Vành',
    bed: 4, bath: 4, area: 600, price: 2684, currency: 'USD',
    frequency: '/Tháng', location: 'Đà Nẵng', view: 'Swimming Pool, near beach',
    folderName: 'Villa PHan ba vành',
    floors: 3
  }
];
...
async function run() {
  ...
  for (const item of properties) {
    ...
    // Handle images
    const sourceDir = path.join(sourceBaseDir, item.folderName);
